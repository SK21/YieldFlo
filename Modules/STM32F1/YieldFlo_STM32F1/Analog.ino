...
void ReadAnalog()
{
	...
	//
	// Conversion-ready interrupt (AlertPin) sets ADSconversionReady.
	...
	{
		// Fallback: STM32 native ADC (12-bit)
		if (UseAnalogFallback) MoistureReading = (int16_t)analogRead(AnalogPin);
	}
}
