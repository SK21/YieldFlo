...
namespace YieldFlo.Forms
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Widened into the space the version label used to occupy: it ended at
            // 327+67=394, which is where this now ends (132+262). The job name is the
            // longest string in the status bar and was the one being truncated.
